          ...
          {services.map((s, i) => (
            <motion.div key={i} variants={itemVariants} className="group">
              <div className="bg-white/90 backdrop-blur-md p-8 rounded-2xl border border-gray-200 hover:border-[#FFA238]/50 transition-all duration-500 hover:bg-white/95 relative overflow-hidden h-full shadow-lg">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold mb-4 relative z-10 group-hover:text-[#FFA238] transition-colors duration-300">
                  {s.title}
                </h3>
                {/* Description */}
                ...
                <ul className="space-y-2 relative z-10">
                  {s.features.map((f, idx) => (
                    ...
                    >
                      <span className="w-1.5 h-1.5 bg-[#FFA238] rounded-full mr-2" />
                      {f}
                    </motion.li>
                  ))}
                </ul>
                {/* Hover border */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#FFA238]/0 via-[#FFA238]/20 to-[#FFA238]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
              </div>
            </motion.div>
          ))}
        </motion.div>
