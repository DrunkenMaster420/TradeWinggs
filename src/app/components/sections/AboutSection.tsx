...
//             className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#232a2f] to-[#4e5458] mb-6 leading-tight"
//           >
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => {
  return (
    <div className="bg-[#ffffff]/90 backdrop-blur-lg p-8 rounded-3xl border border-[#4e5458]/20 group cursor-pointer shadow-lg hover:border-[#ffa238]/30 transition-all duration-300">
      <div className="flex items-center justify-center w-16 h-16 mb-6 bg-gradient-to-br from-[#ffa238]/20 to-[#ffa238]/5 rounded-2xl border border-[#4e5458]/20 text-[#ffa238] group-hover:text-[#ffffff] group-hover:bg-[#ffa238] transition-all duration-300">
        {icon}
      </div>
      <h3 className="text-2xl font-bold text-[#232a2f] mb-3 group-hover:text-[#ffa238] transition-colors duration-300">{title}</h3>
      <p className="text-[#4e5458] leading-relaxed">{description}</p>
    </div>
  );
};
...
const AboutSection = () => {
  ...
  const whyChooseUs = [
    { title: "Expert Team", description: "A passionate team with 5+ years of experience combining creativity, strategy, and technology.", icon: <FiUsers /> },
    { title: "Comprehensive Solutions", description: "From social media and SEO to branding and mobile app creation, we cover all your digital needs.", icon: <FiBriefcase /> },
    { title: "Result-Oriented Strategies", description: "Every campaign is tailored to your brand's needs, ensuring maximum engagement and conversions.", icon: <FiTrendingUp /> },
    { title: "Proven Track Record", description: "Our success stories speak for themselves, with over 200+ satisfied clients and thriving brands.", icon: <FiCheckCircle /> },
    { title: "Transparent Process", description: "We keep you informed at every step with clear reports and data-driven insights for measurable results.", icon: <FiBarChart2 /> }
  ];

  return (
    <section id="about" ref={sectionRef} className="py-24 sm:py-32 bg-[#ffffff] text-[#232a2f] relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#ffa238]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full blur-3xl animate-pulse" style={{ backgroundColor: "rgba(36, 29, 73, 0.1)" }}></div>
        <div
          className="absolute inset-0 bg-grid-white/[0.05]"
          style={{
      ...
      <motion.div variants={sectionVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="container mx-auto px-6 relative z-10">
        {/* Section Badge */}
        <motion.div variants={itemVariants} className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#ffa238]/10 to-[#ffa238]/5 px-4 py-2 rounded-full border border-[#ffa238]/20 mb-6">
            <span className="text-sm font-medium text-[#ffa238]">About Us</span>
        ...
        <motion.div variants={itemVariants} className="text-center max-w-4xl mx-auto mb-20">
          <h2 style={{ WebkitBackgroundClip: "text" }} className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#232a2f] to-[#4e5458] mb-6 leading-tight">
            Your Brand Partner in the Digital World
          </h2>
          <p className="text-lg md:text-xl text-[#4e5458] max-w-3xl mx-auto leading-relaxed">
            At Tradewinggs, we don&apos;t just market brands — we help them make an impact. We combine innovative ideas, data-driven strategies, and eye-catching content to ensure your brand stands out.
          </p>
        </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-[#ffffff]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#4e5458]/20 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-3xl font-bold text-[#232a2f]">Our Mission</h3>
              </div>
              <p className="text-[#4e5458] leading-relaxed">
                To empower brands by creating innovative, result-driven digital marketing strategies that inspire, engage, and convert. We aim to bridge the gap between businesses and their audiences by blending creativity, technology, and data.
              </p>
            </div>
          </motion.div>
          <motion.div variants={itemVariants}>
            <div className="bg-[#ffffff]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#4e5458]/20 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-3xl font-bold text-[#232a2f]">Our Vision</h3>
              </div>
              <p className="text-[#4e5458] leading-relaxed">
                To become a leading name in digital marketing, recognized for transforming ideas into impactful online experiences. We strive to be the go-to creative partner for brands that want to grow, connect, and lead in the digital world.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        {/* Why Choose Us */}
        <motion.div variants={itemVariants} className="text-center mb-16">
          <h3 className="text-4xl md:text-5xl font-bold mb-4 text-[#232a2f]">Why Choose Us?</h3>
          <p className="text-lg text-[#4e5458] max-w-2xl mx-auto">We deliver excellence through a combination of expertise, creativity, and commitment.</p>
        </motion.div>
