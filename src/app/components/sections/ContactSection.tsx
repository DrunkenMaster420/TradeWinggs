...
// const ContactInfoItem = ({ icon: Icon, title, value, href, colorClass }) => (
//   <motion.a
//     href={href}
//     target="_blank"
//     rel="noopener noreferrer"
//     className="flex items-center p-4 rounded-xl group transition-all duration-300 hover:bg-white/5 border border-white/10 hover:border-[#FFA238]/30"
...
//     <section
//       id="contact"
//       className="py-16 md:py-20 bg-gradient-to-br from-[#241D49] via-slate-800 to-[#241D49] relative overflow-hidden"
//     >
...
//                 <motion.div
//                   className="flex items-center p-4 rounded-xl border border-white/10 bg-white/3"
...
//             {/* Quick Response Card */}
//             <motion.div
//               className="bg-gradient-to-r from-[#FFA238]/10 to-[#FFA238]/5 backdrop-blur-sm border border-[#FFA238]/20 rounded-xl p-5"
//               variants={itemVariants}
//             >
//               <div className="text-center">
//                 <div className="bg-[#FFA238]/20 w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-3">
//                   <FaPaperPlane className="text-[#FFA238]" size={16} />
//                 </div>
...
//                     id="from_name"
//                     name="from_name"
//                     className="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-[#FFA238] focus:border-[#FFA238] focus:outline-none transition-all duration-300 peer"
//                     placeholder="Your Name"
//                     required
//                   />
//                   <label
//                     htmlFor="from_name"
//                     className="absolute -top-2.5 left-3 bg-[#241D49] px-2 text-xs text-gray-400 font-medium peer-focus:text-[#FFA238] transition-colors"
//                   >
//                     Full Name *
//                   </label>
//                 </div>
...
//                   name="message"
//                   rows={4}
//                   className="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-[#FFA238] focus:border-[#FFA238] focus:outline-none transition-all duration-300 resize-none peer"
...
//                       className="mt-4 text-center bg-green-500/10 text-green-400 rounded-lg p-4 border border-green-500/20"
//                     >
...
//                       animate={{ opacity: 1, y: 0, scale: 1 }}
//                       exit={{ opacity: 0, y: -15, scale: 0.95 }}
//                       className="mt-4 text-center bg-red-500/10 text-red-400 rounded-lg p-4 border border-red-500/20"
//                     >
//                       <div className="flex items-center justify-center gap-2 mb-1">
//                         <span>❌</span>
